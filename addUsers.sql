...
VALUES
    ("Tomatoes", "Cherry", "Small sweet tomatoes", 24, 85),
    ("Squash", "Yellow", "8 inches long. Yellow in color", 24, 85),
    ("Tomatoes", "Beefsteak", "Large firm tomatoes", 24, 85),
    ("Greens", "Dinosaur Kale", "Wide leaves", 18, 65),
    ("Carrots", "Orange", "2 - 8 inches long", 10, 90);
