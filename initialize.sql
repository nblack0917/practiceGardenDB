DROP TABLE IF EXISTS  usersContact, usersAddress, usersCredentials, gardenPlants, plantVarieties, zone3, zone4, zone5, zone6, zone7, zone8, zone9, zone10, plantParents, gardenBeds, users, plantTypes;
